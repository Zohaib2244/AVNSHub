...
const STORAGE_KEY = "nutmag-slideshow:v1";
const MAX_PHOTOS = 16;
          ...
          >
            <div style={{ minWidth: 0 }}>
              <div
                ...
                style={{ fontSize: "0.98rem", lineHeight: 1.15 }}
              >
        ...
        <>
          ...
          >
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
              {controls}
              <ControlButton label="clear all photos" disabled={!photos.length} onClick={clearPhotos}>
